...
struct TMDarkPinkButtonStyle: TMButtonStyleProtocol {
    ...
    func normalState(button: @escaping () -> UIButton) {
        ...
        button().backgroundColor = UIColor(colorLiteralRed: 126/255, green: 80/255, blue: 95/255, alpha: 1)
    ...
    func highlightedState(button: @escaping () -> UIButton) {
        button().backgroundColor = UIColor.darkPinkHighlighted
    ...
    func inactiveState(button: @escaping () -> UIButton) {
        ...
        button().backgroundColor = UIColor.darkPinkInactive
    }
}
