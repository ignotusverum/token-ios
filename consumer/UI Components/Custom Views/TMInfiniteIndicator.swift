//
//  TMInfiniteIndicator.swift
//  consumer
//
//  Created by Vladislav Zagorodnyuk on 7/13/16.
...
class TMInfiniteIndicator: UIView {
    ...
    fileprivate func registerForAppStateNotifications() {
        NotificationCenter.default.addObserver(self, selector: #selector(TMInfiniteIndicator.restartAnimationIfNeeded), name: NSNotification.Name.UIApplicationWillEnterForeground, object: nil)
    }
