...
class TMNegativeFeedbackView: TMFeedbackRatingView {
    ...
    func drawFace(frame: CGRect = CGRect(x: 0, y: 0, width: 25, height: 25)) {
        ...
        smilePath.move(to: CGPoint(x: face.minX + 0.26876 * face.width, y: face.minY + 0.62126 * face.height))
        smilePath.addCurve(to: CGPoint(x: face.minX + 0.50000 * face.width, y: face.minY + 0.51316 * face.height), controlPoint1: CGPoint(x: face.minX + 0.26876 * face.width, y: face.minY + 0.62126 * face.height), controlPoint2: CGPoint(x: face.minX + 0.35182 * face.width, y: face.minY + 0.51316 * face.height))
        smilePath.addCurve(to: CGPoint(x: face.minX + 0.72718 * face.width, y: face.minY + 0.62126 * face.height), controlPoint1: CGPoint(x: face.minX + 0.64818 * face.width, y: face.minY + 0.51316 * face.height), controlPoint2: CGPoint(x: face.minX + 0.72718 * face.width, y: face.minY + 0.62126 * face.height))
        ...
        rightBrowPath.move(to: CGPoint(x: face.minX + 0.58912 * face.width, y: face.minY + 0.32994 * face.height))
        rightBrowPath.addCurve(to: CGPoint(x: face.minX + 0.66121 * face.width, y: face.minY + 0.35924 * face.height), controlPoint1: CGPoint(x: face.minX + 0.58912 * face.width, y: face.minY + 0.32994 * face.height), controlPoint2: CGPoint(x: face.minX + 0.61000 * face.width, y: face.minY + 0.35924 * face.height))
        rightBrowPath.addCurve(to: CGPoint(x: face.minX + 0.73329 * face.width, y: face.minY + 0.32994 * face.height), controlPoint1: CGPoint(x: face.minX + 0.71242 * face.width, y: face.minY + 0.35924 * face.height), controlPoint2: CGPoint(x: face.minX + 0.73329 * face.width, y: face.minY + 0.32994 * face.height))
        ...
        leftBrowPath.move(to: CGPoint(x: face.minX + 0.30800 * face.width, y: face.minY + 0.33000 * face.height))
        leftBrowPath.addCurve(to: CGPoint(x: face.minX + 0.38008 * face.width, y: face.minY + 0.35930 * face.height), controlPoint1: CGPoint(x: face.minX + 0.30800 * face.width, y: face.minY + 0.33000 * face.height), controlPoint2: CGPoint(x: face.minX + 0.32888 * face.width, y: face.minY + 0.35930 * face.height))
        leftBrowPath.addCurve(to: CGPoint(x: face.minX + 0.45217 * face.width, y: face.minY + 0.33000 * face.height), controlPoint1: CGPoint(x: face.minX + 0.43129 * face.width, y: face.minY + 0.35930 * face.height), controlPoint2: CGPoint(x: face.minX + 0.45217 * face.width, y: face.minY + 0.33000 * face.height))
    ...
    override func runFeedbackAnimationFor(isAnimated: Bool, layer: CAShapeLayer) {
        ...
        if isAnimated {
            let upAnimation = CAKeyframeAnimation(keyPath: "position.x")
            upAnimation.values = [layer.position.x, layer.position.x + 1, layer.position.x, layer.position.x - 1]
            ...
            layer.add(upAnimation, forKey: "negativeAnimation")
        }
    }
}
